...
template <typename>
PROTOBUF_CONSTEXPR StoreMessageResponce::StoreMessageResponce(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.error_)*/ {
    &::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized {}
  }
  ...
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct StoreMessageResponceDefaultTypeInternal {
  PROTOBUF_CONSTEXPR StoreMessageResponceDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
  ~StoreMessageResponceDefaultTypeInternal() {}
  union {
    StoreMessageResponce _instance;
  };
};

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 StoreMessageResponceDefaultTypeInternal _StoreMessageResponce_default_instance_;
template <typename>
...
const ::uint32_t TableStruct_DatabaseHandler_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::StoreMessageResponce, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::StoreMessageResponce, _impl_.success_),
    PROTOBUF_FIELD_OFFSET(::StoreMessageResponce, _impl_.error_),
    ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        ...
        { 20, -1, -1, sizeof(::StoreMessageResponce)},
...
static const ::_pb::Message* const file_default_instances[] = {
    ...
    &::_StoreMessageResponce_default_instance_._instance,
...
const char descriptor_table_protodef_DatabaseHandler_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "\r\n\005error\030\002 \001(\t\"6\n\024StoreMessageResponce\022\017"
...
class StoreMessageResponce::_Internal {
 public:
};

StoreMessageResponce::StoreMessageResponce(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:StoreMessageResponce)
}
StoreMessageResponce::StoreMessageResponce(const StoreMessageResponce& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  StoreMessageResponce* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.error_) {}
  ...
  _this->_impl_.success_ = from._impl_.success_;
  // @@protoc_insertion_point(copy_constructor:StoreMessageResponce)
}

inline void StoreMessageResponce::SharedCtor(::_pb::Arena* arena) {
  (void)arena;
  new (&_impl_) Impl_{
      decltype(_impl_.error_) {}
...
StoreMessageResponce::~StoreMessageResponce() {
  // @@protoc_insertion_point(destructor:StoreMessageResponce)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void StoreMessageResponce::SharedDtor() {
  ABSL_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.error_.Destroy();
}

void StoreMessageResponce::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void StoreMessageResponce::Clear() {
// @@protoc_insertion_point(message_clear_start:StoreMessageResponce)
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* StoreMessageResponce::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "StoreMessageResponce.error"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* StoreMessageResponce::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:StoreMessageResponce)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_error().empty()) {
    const std::string& _s = this->_internal_error();
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "StoreMessageResponce.error");
    target = stream->WriteStringMaybeAliased(2, _s, target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:StoreMessageResponce)
  return target;
}

::size_t StoreMessageResponce::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:StoreMessageResponce)
  ::size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData StoreMessageResponce::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    StoreMessageResponce::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*StoreMessageResponce::GetClassData() const { return &_class_data_; }


void StoreMessageResponce::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<StoreMessageResponce*>(&to_msg);
  auto& from = static_cast<const StoreMessageResponce&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:StoreMessageResponce)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void StoreMessageResponce::CopyFrom(const StoreMessageResponce& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:StoreMessageResponce)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool StoreMessageResponce::IsInitialized() const {
  return true;
}

void StoreMessageResponce::InternalSwap(StoreMessageResponce* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata StoreMessageResponce::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_DatabaseHandler_2eproto_getter, &descriptor_table_DatabaseHandler_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::StoreMessageResponce*
Arena::CreateMaybeMessage< ::StoreMessageResponce >(Arena* arena) {
  return Arena::CreateMessageInternal< ::StoreMessageResponce >(arena);
}
