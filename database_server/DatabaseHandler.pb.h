...
class StoreMessageResponce;
struct StoreMessageResponceDefaultTypeInternal;
extern StoreMessageResponceDefaultTypeInternal _StoreMessageResponce_default_instance_;
...
template <>
::StoreMessageResponce* Arena::CreateMaybeMessage<::StoreMessageResponce>(Arena*);
template <>
...
class StoreMessageResponce final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:StoreMessageResponce) */ {
 public:
  inline StoreMessageResponce() : StoreMessageResponce(nullptr) {}
  ~StoreMessageResponce() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR StoreMessageResponce(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  StoreMessageResponce(const StoreMessageResponce& from);
  StoreMessageResponce(StoreMessageResponce&& from) noexcept
    : StoreMessageResponce() {
    *this = ::std::move(from);
  }

  inline StoreMessageResponce& operator=(const StoreMessageResponce& from) {
    CopyFrom(from);
    return *this;
  }
  inline StoreMessageResponce& operator=(StoreMessageResponce&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const StoreMessageResponce& default_instance() {
    return *internal_default_instance();
  }
  static inline const StoreMessageResponce* internal_default_instance() {
    return reinterpret_cast<const StoreMessageResponce*>(
               &_StoreMessageResponce_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(StoreMessageResponce& a, StoreMessageResponce& b) {
    a.Swap(&b);
  }
  inline void Swap(StoreMessageResponce* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(StoreMessageResponce* other) {
    if (other == this) return;
    ABSL_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  StoreMessageResponce* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StoreMessageResponce>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const StoreMessageResponce& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const StoreMessageResponce& from) {
    StoreMessageResponce::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StoreMessageResponce* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "StoreMessageResponce";
  }
  protected:
  explicit StoreMessageResponce(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:StoreMessageResponce)
 private:
  class _Internal;
...
// bool success = 1;
inline void StoreMessageResponce::clear_success() {
  _impl_.success_ = false;
}
inline bool StoreMessageResponce::success() const {
  // @@protoc_insertion_point(field_get:StoreMessageResponce.success)
  return _internal_success();
}
inline void StoreMessageResponce::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:StoreMessageResponce.success)
}
inline bool StoreMessageResponce::_internal_success() const {
  return _impl_.success_;
}
inline void StoreMessageResponce::_internal_set_success(bool value) {
  ;
  _impl_.success_ = value;
}

// string error = 2;
inline void StoreMessageResponce::clear_error() {
  _impl_.error_.ClearToEmpty();
}
inline const std::string& StoreMessageResponce::error() const {
  // @@protoc_insertion_point(field_get:StoreMessageResponce.error)
  return _internal_error();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void StoreMessageResponce::set_error(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.error_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:StoreMessageResponce.error)
}
inline std::string* StoreMessageResponce::mutable_error() {
  std::string* _s = _internal_mutable_error();
  // @@protoc_insertion_point(field_mutable:StoreMessageResponce.error)
  return _s;
}
inline const std::string& StoreMessageResponce::_internal_error() const {
  return _impl_.error_.Get();
}
inline void StoreMessageResponce::_internal_set_error(const std::string& value) {
  ;


  _impl_.error_.Set(value, GetArenaForAllocation());
}
inline std::string* StoreMessageResponce::_internal_mutable_error() {
  ;
  return _impl_.error_.Mutable( GetArenaForAllocation());
}
inline std::string* StoreMessageResponce::release_error() {
  // @@protoc_insertion_point(field_release:StoreMessageResponce.error)
  return _impl_.error_.Release();
}
inline void StoreMessageResponce::set_allocated_error(std::string* value) {
  _impl_.error_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.error_.IsDefault()) {
          _impl_.error_.Set("", GetArenaForAllocation());
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:StoreMessageResponce.error)
}
