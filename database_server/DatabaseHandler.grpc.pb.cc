...
::grpc::Status Database::Stub::StoreMessage(::grpc::ClientContext* context, const ::Message& request, ::StoreMessageResponce* response) {
  return ::grpc::internal::BlockingUnaryCall< ::Message, ::StoreMessageResponce, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_StoreMessage_, context, request, response);
}

void Database::Stub::async::StoreMessage(::grpc::ClientContext* context, const ::Message* request, ::StoreMessageResponce* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::Message, ::StoreMessageResponce, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_StoreMessage_, context, request, response, std::move(f));
}

void Database::Stub::async::StoreMessage(::grpc::ClientContext* context, const ::Message* request, ::StoreMessageResponce* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::StoreMessageResponce>* Database::Stub::PrepareAsyncStoreMessageRaw(::grpc::ClientContext* context, const ::Message& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::StoreMessageResponce, ::Message, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_StoreMessage_, context, request);
}

::grpc::ClientAsyncResponseReader< ::StoreMessageResponce>* Database::Stub::AsyncStoreMessageRaw(::grpc::ClientContext* context, const ::Message& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
Database::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Database::Service, ::Message, ::StoreMessageResponce, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Database::Service* service,
             ::grpc::ServerContext* ctx,
             const ::Message* req,
             ::StoreMessageResponce* resp) {
...
::grpc::Status Database::Service::StoreMessage(::grpc::ServerContext* context, const ::Message* request, ::StoreMessageResponce* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
